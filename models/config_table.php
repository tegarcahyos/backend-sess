...
class ConfigTable
{
    ...
    public function insert($tablename)
    {
        ...
        $query = "INSERT INTO $tablename (name, type_table, object_id, object_name, object_table, selected_data, form_id, selected_button_action, next_page_id)";
        $query .= "VALUES ('$name' , $type_table, $object_id, '$object_name' , '$object_table', '$selected_data', '$form_id', '$selected_button_action', '$next_page_id')";
        // die($query);
    ...
    public function update($id, $tablename)
    {
        ...
        $query = "UPDATE $tablename SET type_table = $type_table, object_name = '$object_name', name = '$name', object_id = $object_id, object_table = '$object_table', selected_data = '$selected_data', form_id = '$form_id', selected_button_action = '$selected_button_action', next_page_id ='$next_page_id' WHERE id =  '$id'";
        // die($query);
        return $this->db->execute($query);
    }
