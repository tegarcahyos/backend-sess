...
class ConfigList
{
    ...
    public function insert($tablename)
    {
        ...
        $query = "INSERT INTO $tablename (name, type_list, object_id, object_name, object_table, selected_data, detail_page_id)";
    ...
    public function update($id, $tablename)
    {
        ...
        $query = "UPDATE $tablename SET type_list = '$type_list', object_name = '$object_name', name = '$name', object_id = '$object_id', object_table = '$object_table', selected_data = '$selected_data', detail_page_id ='$detail_page_id' WHERE id =  '$id'";
        // die($query);
        return $this->db->execute($query);
    }
