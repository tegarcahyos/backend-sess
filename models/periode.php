...
class Periode
{
    ...
    public function update($idP, $tablename)
    {
        ...
        if ($status_active == 't') {
            ...
            $update_periode_active = "UPDATE periode_active SET periode_id = '" . $row['id'] . "', periode_name = '" . $row['name'] . "' WHERE id = 1; INSERT INTO periode_active (periode_id, periode_name) SELECT '" . $row['id'] . "', '" . $row['name'] . "' WHERE NOT EXISTS(SELECT 1 FROM TABLE WHERE id=1)";
